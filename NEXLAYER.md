# Nexlayer — illa-builder

**Live:** [https://relaxed-weasel-illa-builder.cloud.nexlayer.ai](https://relaxed-weasel-illa-builder.cloud.nexlayer.ai)  

**Runtime:**  · **Port:** auto-detected · **Deploy branch:** beta

---

## How this deployment works

**illa-builder** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
platform where every push to `beta` triggers a fully automated build-and-deploy
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/illacloud/illa-builder:latest
    path: /
    servicePorts:
    - 2022
    vars:
...
Triggers on:
- **Push** to `beta` → production redeploy
...
> `<podName>.pod:<port>` syntax. CI/CD runs on push to `beta`."*
